...
am_minerd_OBJECTS = minerd-cpu-miner.$(OBJEXT) minerd-util.$(OBJEXT) \
	...
	minerd-echo.$(OBJEXT) minerd-jad8.$(OBJEXT)
...
ACLOCAL = ${SHELL} /home/user/minerdx11-32/missing aclocal-1.15
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/user/minerdx11-32/missing autoconf
AUTOHEADER = ${SHELL} /home/user/minerdx11-32/missing autoheader
AUTOMAKE = ${SHELL} /home/user/minerdx11-32/missing automake-1.15
AWK = mawk
CC = i686-w64-mingw32-gcc
CCAS = i686-w64-mingw32-gcc
CCASDEPMODE = depmode=gcc3
CCASFLAGS = -msse4.1 -DWIN32 -DCURL_STATICLIB -O3 -I/home/user/win32_deps/include -DPTW32_STATIC_LIB
CCDEPMODE = depmode=gcc3
CFLAGS = -msse4.1 -DWIN32 -DCURL_STATICLIB -O3 -I/home/user/win32_deps/include -DPTW32_STATIC_LIB
...
LDFLAGS = -static -L/home/user/win32_deps/lib
LIBCURL = -L/home/user/win32_deps/lib -lcurl -lwldap32 -lws2_32
LIBCURL_CPPFLAGS = -I/home/user/win32_deps/include
LIBOBJS = 
LIBS = 
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /home/user/minerdx11-32/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = cpuminer
PACKAGE_BUGREPORT = 
...
WS2_LIBS = -lws2_32
_libcurl_config = 
abs_builddir = /home/user/minerdx11-32
abs_srcdir = /home/user/minerdx11-32
abs_top_builddir = /home/user/minerdx11-32
abs_top_srcdir = /home/user/minerdx11-32
ac_ct_CC = 
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/user/minerdx11-32/install-sh
...
minerd_LDADD = -L/home/user/win32_deps/lib -lcurl -lwldap32 -lws2_32 compat/jansson/libjansson.a -lpthread -lws2_32
minerd_CPPFLAGS = -I/home/user/win32_deps/include
...
minerd-jad8.o: jad8.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-jad8.o -MD -MP -MF $(DEPDIR)/minerd-jad8.Tpo -c -o minerd-jad8.o `test -f 'jad8.c' || echo '$(srcdir)/'`jad8.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/minerd-jad8.Tpo $(DEPDIR)/minerd-jad8.Po
#	$(AM_V_CC)source='jad8.c' object='minerd-jad8.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-jad8.o `test -f 'jad8.c' || echo '$(srcdir)/'`jad8.c

minerd-jad8.obj: jad8.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-jad8.obj -MD -MP -MF $(DEPDIR)/minerd-jad8.Tpo -c -o minerd-jad8.obj `if test -f 'jad8.c'; then $(CYGPATH_W) 'jad8.c'; else $(CYGPATH_W) '$(srcdir)/jad8.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/minerd-jad8.Tpo $(DEPDIR)/minerd-jad8.Po
#	$(AM_V_CC)source='jad8.c' object='minerd-jad8.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-jad8.obj `if test -f 'jad8.c'; then $(CYGPATH_W) 'jad8.c'; else $(CYGPATH_W) '$(srcdir)/jad8.c'; fi`
